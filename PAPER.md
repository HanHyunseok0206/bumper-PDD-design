...
*(작성 예정 — 스트레치 목표, 구현 전. 크리깅이 제공하는 예측 불확실성을 이용해 (1) 서로게이트 보강에 쓸 다음 DOE 점을 능동적으로 선택하는 능동학습, (2) 강건 최적점 탐색에 획득함수를 사용하는 베이지안 최적화를 순서대로 도입 예정. 상세 검토는 `GUIDELINE.md`의 "AI 요소 추가" 절 참고.)*
...
- 4.4 능동학습/베이지안 최적화 적용 결과 (스트레치, 진행 시)
